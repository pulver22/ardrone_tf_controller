...
class USVController
{
  private:
    ...
    // Service to invoke control's publisher (cmd_pub_)
    ...
    */
    // bool setModelState(ardrone_tf_controller::ResetPosition::Request &req,
    //                   ardrone_tf_controller::ResetPosition::Response &res);
    ...
    @param res is an empty message
    */
    // bool sendCommand(ardrone_tf_controller::SendCommand::Request &req,
    //                 ardrone_tf_controller::SendCommand::Response &res);
...
USVController::USVController()
{
  ...
  //service_reset_ = nh_.advertiseService("ardrone_tf_controller/set_model_state", &USVController::setModelState, this);
  set_state_client_ = nh_.serviceClient<gazebo_msgs::SetModelState>("/gazebo/set_model_state");
  //service_send_command_ = nh_.advertiseService("ardrone_tf_controller/send_command", &USVController::sendCommand, this);
...
int main(int argc, char **argv)
{
  ...
  while(ros::ok())
  {
    ...
    // Calculate the repative pose of the quadrotor to the USV at every iteration
